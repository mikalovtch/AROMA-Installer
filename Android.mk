...
include $(CLEAR_VARS)
  ...
  ifneq ($(filter-out arm64 x86_64, $(TARGET_ARCH)),)
...
ifeq ($(AROMA_MINUI),true)
  LOCAL_SRC_FILES += src/libs/aroma_minui.cpp
  LOCAL_STATIC_LIBRARIES += libminui libpng
  LOCAL_C_INCLUDES += bootable/recovery/minui/include external/png
  LOCAL_CFLAGS += -DAROMA_MINUI=1
endif
